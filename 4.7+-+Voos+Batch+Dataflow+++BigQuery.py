...
pipeline_options = {
    ...
    'template_location': 'gs://curso-dataflow-mss/template/batch_job_df_gcs_big_query_voos',
...
tabela = 'curso-dataflow-mss-389219.curso_dataflow_voos.curso_dataflow_voos_atraso'
...
#    | beam.Map(print)
    | beam.io.WriteToBigQuery(
                              ...
                              custom_gcs_temp_location = 'gs://curso-dataflow-mss/temp' )
